...
<table border="0" cellspacing="10" width="900" style="table-layout:fixed">
	...
	<tr>
		<td width="5%"></td>	
		<td width="95%">
			>> <u>To kill any running process</u>, search it to on the host machine with its ID, found in the ID column field. Ex: "ps -ef | grep rid_<i>123</i>". Remember, this is not PID; this is the id used by this system for that process instance.
