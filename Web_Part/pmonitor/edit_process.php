...
<?php 
	...
	*/
	...
	//Get data from MySql to fillup all the text area
	$getRow = "SELECT 
				request_token,
				status, 
				script, 
	...
	$result = mysql_query($getRow) or die(mysql_error());
	...
	if($result){						
		...
		print "<script> alert('Error in fetching data')</script>";	
		mysql_close();				
	}
	/////
