    ...
    <td>
	  ...
	  <tbody align="center" style="background-color:#7E587E; font-size:12px; color:#FFFFFF">
		  <tr height="30">
			...
			<td width="15%"><b>HOST</b></td>			
			<td width="10%"><b>STATUS</b></td>			
			<td width="11%"><b>ENTRY TIME</b></td>						
	  ...
	  <tbody align="center" style="font-size:12px">
		...
		<?php				
			...
			$query = "SELECT a.id, a.request, b.script, b.host, a.status, a.entry_time, a.start_time, a.end_time
			...
			*/
			...
			while($data = mysql_fetch_row($result))
			{
				...
				/*echo("<tr>
					...
					if($data[4]=="Error")	$status="<b style=\"color:#810541\">ERROR</b>";		//RED
					else if($data[4]=="Done")	$status="<b style=\"color:#254117\">DONE</b>";	//GREEN
					else if($data[4]=="Running")	$status="<b style=\"color:#666600\">$data[4]</b>";	
					else if($data[4]=="Failed")	$status="<b style=\"color:#EE0000\">FAILED</b>";	
					else if(strpos($data[4],"TH")>0)	$status="<b style=\"color:#CC0000\">$data[4]</b>";		//RED
					else $status="<b>$data[4]</b>";		//BLACK default
